                ...
                with open(log_file,'r') as logfd:
                        for log_line in logfd:
                            if "{BEGIN:" in log_line or "BEGIN: " in log_line:
                                ...
                                #extract_fd.write("begin_time = " + begin_time + '\n')
                                #extract_fd.write("end_time = " + end_time + '\n')
                                #logging.info("begin_time = " + begin_time + '\n')
                                #logging.info("end_time = " + end_time + '\n')
                                #logging.info('start_t_h = ' + str(start_t_h)) 
                                #logging.info('start_t_m = ' + str(start_t_m)) 
                                #logging.info('start_t_s = ' + str(start_t_s))
                                #logging.info('start_t_ms = ' + str(start_t_ms))
                                #logging.info('end_t_h = ' + str(end_t_h)) 
                                #logging.info('end_t_m = ' + str(end_t_m)) 
                                #logging.info('end_t_s = ' + str(end_t_s)) 
                                #logging.info('end_t_ms = ' +str(end_t_ms))
                                #
                                #extract_fd.write('start_t_h = ' + str(start_t_h)) 
                                #extract_fd.write('start_t_m = ' + str(start_t_m)) 
                                #extract_fd.write('start_t_s = ' + str(start_t_s))
                                #extract_fd.write('start_t_ms = ' + str(start_t_ms))
                                #extract_fd.write('end_t_h = ' + str(end_t_h)) 
                                #extract_fd.write('end_t_m = ' + str(end_t_m)) 
                                #extract_fd.write('end_t_s = ' + str(end_t_s)) 
                                #extract_fd.write('end_t_ms = ' +str(end_t_ms))
