...
class Logger:
    ...
    def get_instance(self, classid = "Main", use_cache = TRUE):
        ...
        if (type(classid) == ClassType):
            ...
            classid = classid.__class__.__name__ #IGNORE:E1101
        ...
        if ((cache.has_key(classid)) and (use_cache == TRUE)):
            ...
            targets = instance.__Logger_targets #IGNORE:E1101
            deepcopyable = TRUE
    ...
    def __Logger_setdefaults(self):
        ...
        try:
            self.__Logger_timeformat = "%s %s" % (locale.nl_langinfo(locale.D_FMT), locale.nl_langinfo(locale.T_FMT)) #IGNORE:E1101
